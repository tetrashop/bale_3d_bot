...
def start(update: Update, context: CallbackContext):
    update.message.reply_text("سلام! لطفا یک عکس ارسال کنید تا مدل سه‌بعدی ساخته شود.")
...
def handle_photo(update: Update, context: CallbackContext):
    ...
    update.message.reply_text("عکس دریافت شد، مدل سه‌بعدی در حال ساخته شدن است...")
